...
public:
    ...
    void blockTopColli(Stage *stage, std::vector<Block*> Blocks, Player *player, float dt);
    void blockBotSideColli(Stage *stage, std::vector<Block*> Blocks, Player *player, float dt);
